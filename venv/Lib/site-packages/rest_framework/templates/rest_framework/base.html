          ...
          <div class="container">
            ...
            <ul class="nav navbar-nav pull-right">
              ...
              {% if user.is_authenticated %}
                  ...
                  <a href="{% url 'logout' %}" class="btn btn-danger btn-sm" style="margin-top: 10px;">Logout</a>
              {% else %}
                  <a href="{% url 'login_page' %}" class="btn btn-primary btn-sm" style="margin-top: 10px;">Login</a>
              {% endif %}
          {% endblock %}
